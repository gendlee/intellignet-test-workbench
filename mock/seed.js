...
const CASE_SPECS = [
  ...
  { txnCode: 'PAYM2001', name: '轉賬 — 新系統新增字段', module: '轉賬', req: REQ.pay, profile: 'diff-added-field', stateType: 'STATEFUL', status: 'APPROVED', precondition: '需先完成轉賬授權簽核' },
  { txnCode: 'PAYM2002', name: '轉賬 — 新系統缺少字段', module: '轉賬', req: REQ.pay, profile: 'diff-missing-field', stateType: 'STATEFUL', status: 'PENDING', precondition: '需先完成轉賬授權簽核' },
